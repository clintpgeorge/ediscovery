...
class file_list_control(wx.Panel):
    def __init__(self, parent, id, target_dir):
        ...
        control_sizer.Add(self.select_button, 0, wx.ALL| wx.ALIGN_CENTER, 5)
        control_sizer.Add(self.remove_button, 0, wx.ALL | wx.ALIGN_CENTER, 5)
        control_sizer.Add(self.save_button, 0, wx.ALL | wx.ALIGN_CENTER, 5)
